...
public class TestLogger {
	...
	//private static Calendar cal = Calendar.getInstance();  // For date in log file name uncomment this code
	//private static SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy"); // For date in log file name uncomment this code
	//private static final String logProperttFilePath = "src/test/resources/log4j.properties";
	private static final String logProperttFilePath = "src/test/resources/log4j-h.properties";
	  ...
	  static {
		...
		public static org.apache.log4j.Logger createLogger() {
		    if (_logger == null) {
		        _logger = LogManager.getLogger(TestLogger.class);
